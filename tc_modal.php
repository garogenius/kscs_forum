	...
	<div   id="tc" tabindex="-1" >
		<div class="modal-dialog">
			...
			<a href="index.php" type="button" class="close"  >&times;</a>
				<h4 class="modal-title" id="myModalLabel">kscs  Terms and Conditions</h4>
			</div>
			<div class="modal-body">
			<p>
By using the message board(s) you agree to these terms and conditions.<br /><br />
All messages are the opinions of the author and are not the views or opinions of KSCS FORUM for IT Professional and Students ("FIPAS").  Please note that some of the boards may be intended for use by young people; please have regard to this.<br /><br />
